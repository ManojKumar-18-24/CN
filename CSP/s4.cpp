...
void service(string client_ip)
{
    ...
    ip_header->ip_len = sizeof(struct ip) + sizeof("Hello Client you are serviced by s4"); // Total length
    ...
    ip_header->ip_src.s_addr = inet_addr("172.03.0.121");  // Source IP
    ...
    strcpy(data, "Hello Client you are serviced by s4");
